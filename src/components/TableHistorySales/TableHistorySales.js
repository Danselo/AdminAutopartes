...
import { buttonBodyTemplate } from "./columnTemplatesHistorySales";

export const TableHistorySales = () => {
    ...
    return (
        <DataTable header="Historial de ventas" value={historySales} resizableColumns columnResizeMode="expand" stripedRows paginator responsiveLayout="scroll" dataKey="id" emptyMessage="No se encontraron datos" className="table-product" rows={10}>
