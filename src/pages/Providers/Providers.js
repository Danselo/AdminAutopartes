...
export default function Providers() {
    ...
    const rightContents = (
        ...
        // </React.Fragment>
        <React.Fragment>
            <Button label={providerSelected.status ? "Desactivar" : "Activar"}
                                    ...
                                    render={({ input, meta }) => (
                                        <div className="field">
                                            <span className="create-sale-form__span">
                                                ...
                                                <InputText id="nit" {...input} placeholder="Nit o indicador del proveedor" className={classNames({ "p-invalid": isFormFieldValid(meta), "create-provider-form__input": true })} tooltip="Si es proveedor internacinal, por favor ingrese un indentificador para este proveedor" />
                                            </span>
                                            <br />
